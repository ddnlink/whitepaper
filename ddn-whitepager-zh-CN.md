...
- [5. 基础架构](#5-基础架构)
    ...
    - [5.3 主要特点](#53-主要特点)
        - [5.3.1 多链并行](#531-多链并行)
        - [5.3.2 多终端使用](#532-多终端使用)
        - [5.3.3 模块化设计](#533-模块化设计)
        - [5.3.4 可视化定制](#534-可视化定制)
    - [5.4 核心优势](#54-核心优势)
- [6. 核心技术](#6-核心技术)
    - [6.1 DDN区块链](#61-ddn区块链)
        - [6.1.1 共识机制](#611-共识机制)
        - [6.1.2 受托人](#612-受托人)
        - [6.1.3 点对点网络](#613-点对点网络)
    - [6.2 侧链技术](#62-侧链技术)
        - [6.2.1 虚拟机](#621-虚拟机)
        - [6.2.2 Dapp开发](#622-dapp开发)
        - [6.2.3 Dapp运算](#623-dapp运算)
        - [6.2.4 Dapp共识算法](#624-dapp共识算法)
        - [6.2.5 Dapp主节点](#625-dapp主节点)
    - [6.3 跨链技术](#63-跨链技术)
        - [6.3.1 具名路由](#631-具名路由)
        - [6.3.2 智能网盘](#632-智能网盘)
        - [6.3.3 智能资产](#633-智能资产)
...
- [7. 商业布局](#7-商业布局)
    - [7.1 应用前景](#71-应用前景)
        - [7.1.1 知识产权保护](#711-知识产权保护)
        - [7.1.2 大数据管理](#712-大数据管理)
        - [7.1.3 物联网](#713-物联网)
        - [7.1.4 健康医疗](#714-健康医疗)
        - [7.1.5 政务管理](#715-政务管理)
        - [7.1.6 金融保险](#716-金融保险)
        - [7.1.7 企业管理](#717-企业管理)
    - [7.2 典型案例](#72-典型案例)
    - [7.2.1 Ebookchain](#721-ebookchain)
        - [7.2.2 LimsChain](#722-limschain)
        - [7.2.3 艺术品管理系统](#723-艺术品管理系统)
    - [7.3 技术孵化](#73-技术孵化)
    - [7.4 自治社区](#74-自治社区)
- [8.路线图](#8路线图)
    - [8.1 第一阶段](#81-第一阶段)
...
**Data Delivery Network**，DDN，数据分发网络，充分利用区块链技术进行存储、索引、检索、寻址和分发，最大限度地避开基于TCP/IP网络的限制，使数据传输更安全、更准确、更快速，让数据有权属，有价值。
